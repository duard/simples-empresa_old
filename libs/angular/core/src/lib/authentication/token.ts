// import { capitalize, now, timeLeft } from '@simples-empresa/angular/core'
// import { RefreshToken, Token } from '@simples-empresa/angular/core'

import { now, capitalize, timeLeft } from './helpers'
