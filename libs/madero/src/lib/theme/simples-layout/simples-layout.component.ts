...
import { SettingsService, AppSettings } from '@simples-empresa/angular/core'
import { AppDirectionality } from '@simples-empresa/angular/shared'
...
@Component({
  selector: 'app-simples-layout',
  templateUrl: './simples-layout.component.html',
  styleUrls: ['./simples-layout.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class SimplesLayoutComponent implements OnDestroy {
